...
You can install the development version of SARtisanal from [GitHub](https://github.com/) with:
...
User guide to use and apply `SARtisanal`packages and functions colud be fupnd in this repo; [SARtisanal package](https://mauromardones.github.io/SARtisanal/) 
